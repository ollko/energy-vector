...
from generic.mixins import GensetengineListMixin, PageNumberMixin
from generic.controllers import PageNumberView


class NewListView(ListView, GensetengineListMixin):
    model = New
...
class NewCreate(SuccessMessageMixin, CreateView, GensetengineListMixin):
    model = New
...
class NewUpdate(SuccessMessageMixin,  UpdateView):
    model = New
